...
router.get('/login', isAuthenticated,adminController.loginView);  /* will show admin login page */
router.post("/login", validateAdminSignin,adminController.handleLogin);
...
// Profile
router.get('/my-profile', isAuthenticated, adminController.myProfilePage);
router.post('/update-profile',  adminController.updateUserValidation,adminController.postUpdateProfile);

router.get('/forget',  adminController.forgetLoad);
router.post('/forget',  adminController.forgetVerifyPassword);
router.get('/forget-password',  adminController.forgetPasswordLoad);
router.post('/forgets',  adminController.resetPassword);


//router.get("/admin/users", users.getUsers);
router.get("/users", users.getUsers); /* New */
router.post("/users", users.getUsers); /* New */

// Chat
router.get("/chat", isAuthenticated,adminController.loadChat);
